        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${
              view === 'foods' ? 'bg-secondary text-secondary-foreground' : 'bg-muted text-muted-foreground'
            }`}
          >
            Aliments
          </button>
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${
              view === 'recipes' ? 'bg-secondary text-secondary-foreground' : 'bg-muted text-muted-foreground'
            }`}
          >
            Recettes
          </button>
            ...
            <div className="grid grid-cols-3 gap-2">
              {filtered.map(food => (
                <button
                  ...
                  className="p-3 rounded-xl bg-card card-shadow text-center hover:bg-muted transition-colors"
                >
          ...
          <div className="flex flex-col gap-3">
            {recipes.map(recipe => (
              <button
                ...
                className="p-4 rounded-xl bg-card card-shadow flex items-center gap-4 text-left hover:bg-muted transition-colors"
              >
